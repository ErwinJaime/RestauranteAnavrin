    ...
    <div class="main-content">
      ...
      <div class="resenas-container">
        <div
          ...
          class="resena-card"
        >
          <button class="btn-eliminar" @click="eliminarResenaConfirmado(resena.id)">✕</button>
...
import { listarTodasResenas, eliminarResena } from '@/services/productos';
...
const cargarResenas = async () => {
  try {
    cargando.value = true;
    const response = await listarTodasResenas();
...
const eliminarResenaConfirmado = async (id) => {
